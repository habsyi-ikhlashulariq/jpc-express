...
@section('content')   
        <div class="panel-body">
            ...
            {{ csrf_field() }}
            {{ method_field('PUT') }}
            <input class="form-control" placeholder="Nama Customer" type="hidden" name="id" value="{{ $customer->id }}"><br>
                <div class="row">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <textarea name="alamatCustomer" id="" cols="67" rows="5">{{ $customer->alamatCustomer }}
                        </textarea>
                        <br>
                ...
                <div class="row">
                    ...
                    <a href="{{ url('admin/customer') }}" class="btn btn-danger">Kembali</a>
                    </div>
                </div>
            </form>
        </div>
