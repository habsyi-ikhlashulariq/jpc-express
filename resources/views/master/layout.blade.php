			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
                        ...
                        <li>
							<a href="#subPages" data-toggle="collapse" class="collapsed"><i class="lnr lnr-file-empty"></i> <span>Counter</span> <i class="icon-submenu lnr lnr-chevron-left"></i></a>
							<div id="subPages" class="collapse ">
								<ul class="nav">
									<li><a href="{{ url('/customer')}}" class="">Data Pelanggan</a></li>
									<li><a href="{{ url('/cek_resi')}}" class="">Cek Resi</a></li>
									<li><a href="{{ url('/data_penjualan')}}" class="">Laporan Penjualan</a></li>
								</ul>
							</div>
						</li>
